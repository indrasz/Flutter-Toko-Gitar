...
import 'package:toko_gitar_flutter/Screens/User/Transaksi/DataTransaksiUser.dart';
      ...
      child: Column(children: [
        Row(children: [
          Expanded(
            ...
            onTap: () {
              Navigator.pushNamed(context, DataGitarScreens.routeName);
            },
            child: Container(
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  Image.network(
                      "https://cdn-icons-png.flaticon.com/32/2856/2856892.png"),
                  Padding(
                    padding: EdgeInsets.only(left: 16),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
